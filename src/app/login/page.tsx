...
import {
  ...
  Phone, ChevronRight, Sparkles, Sun, Moon,
} from "lucide-react";
...
const DEPARTMENTS = [
  "Computer Science", "Software Engineering", "Medicine",
  "Pharmacy", "Civil Engineering", "Electrical Engineering",
  "Law", "Economics", "Nursing",
];
    ...
    <div className="min-h-screen flex bg-[#0a0f1e] overflow-hidden">
      ...
      <div className="hidden lg:flex flex-col w-[52%] relative overflow-hidden">
        ...
        <div className="absolute inset-0"
          style={{ backgroundImage: "radial-gradient(circle at 20% 50%, rgba(26,86,219,0.25) 0%, transparent 60%), radial-gradient(circle at 80% 20%, rgba(245,158,11,0.15) 0%, transparent 50%)" }}
        />
        ...
        <div className="absolute bottom-1/3 right-1/4 w-80 h-80 bg-amber-500/10 rounded-full blur-3xl animate-pulse" style={{ animationDelay: "1.5s" }} />
        ...
        <div className="relative z-10 flex flex-col h-full p-12">
          ...
          {/* Central illustration — premium graduation visual */}
          <div className="flex-1 flex flex-col items-center justify-center gap-8">
            {/* University cap SVG illustration */}
            <div className="relative">
              <div className="w-48 h-48 bg-gradient-to-br from-blue-600/30 to-indigo-700/30 rounded-full flex items-center justify-center border border-white/10 backdrop-blur-sm">
                <div className="w-36 h-36 bg-gradient-to-br from-blue-500/40 to-indigo-600/40 rounded-full flex items-center justify-center border border-white/15">
              ...
              {DEPARTMENTS.slice(0, 4).map((dept, i) => {
                ...
                return (
                  <div key={dept}
                    className="absolute glass rounded-full px-3 py-1 text-xs text-white/80 border border-white/10 whitespace-nowrap"
              ...
              {/* Gold ring */}
              <div className="absolute -inset-2 rounded-full border border-amber-400/20 border-dashed animate-spin" style={{ animationDuration: "20s" }} />
            </div>

            {/* Headline */}
            <div className="text-center space-y-3 max-w-sm">
              <h2 className="text-3xl font-bold text-white leading-snug">
                Ace Your <span className="text-gold-gradient">Exit Exam</span><br />with Confidence
              </h2>
      ...
      <div className="flex-1 flex flex-col items-center justify-center px-6 py-12 bg-white dark:bg-[#0d1117] relative">
        ...
        <div className="w-full max-w-[400px] space-y-7">
          ...
          <div className="lg:hidden flex items-center gap-3 justify-center">
            ...
            <div>
              <p className="text-gray-900 dark:text-white font-bold text-base leading-none">Exit Exam Ethiopia</p>
            </div>
          </div>
          ...
          <form onSubmit={handleLogin} className="space-y-4">
              ...
              <>
                ...
                <div className="space-y-1.5">
                  <div className="flex items-center justify-between">
                    ...
                    <Link href="/forgot-password" className="text-xs text-blue-600 dark:text-blue-400 hover:underline">Forgot?</Link>
                  </div>
                  <div className="relative">
              ...
              <div className="space-y-1.5">
                ...
                <div className="relative">
                  <div className="absolute left-3.5 top-1/2 -translate-y-1/2 flex items-center gap-1">
                    ...
                    <span className="text-xs text-gray-400">+251</span>
                  </div>
                ...
                <p className="text-xs text-gray-400">We&apos;ll send you a verification code via Telegram OTP</p>
              </div>
            )}
            ...
            >
              {loading ? (<><Loader2 className="w-4 h-4 animate-spin" />Signing in…</>) : (
                <>{tab === "phone" ? "Send OTP Code" : "Sign In"}<ChevronRight className="w-4 h-4" /></>
              )}
            </button>
          </form>
          ...
          <div className="grid grid-cols-2 gap-3">
            ...
            {/* Telegram */}
            <button
              onClick={() => { /* Telegram OTP */ }}
              className="flex items-center justify-center gap-2.5 py-2.5 rounded-xl border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors text-sm font-medium text-gray-700 dark:text-gray-300 shadow-sm"
            >
              <svg className="w-4 h-4 text-[#26A5E4]" viewBox="0 0 24 24" fill="currentColor">
                <path d="M12 0C5.373 0 0 5.373 0 12s5.373 12 12 12 12-5.373 12-12S18.627 0 12 0zm5.562 8.248l-2.008 9.461c-.147.658-.537.818-1.084.508l-3-2.21-1.447 1.394c-.16.16-.295.295-.605.295l.213-3.053 5.56-5.023c.242-.213-.054-.333-.373-.12l-6.871 4.326-2.962-.924c-.643-.204-.657-.643.136-.953l11.566-4.461c.537-.194 1.006.131.875.76z"/>
              </svg>
              Telegram OTP
            </button>
          </div>
